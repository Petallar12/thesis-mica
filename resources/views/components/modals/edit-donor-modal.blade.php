                ...
                <form id="editDonorForm" method="POST" class="mt-4">
                    ...
                    <div id="edit-personal" class="tab-content active">
                        <div class="form-group grid grid-cols-2 gap-4">
                            ...
                            <div class="input-group"><label>Gender *</label><select name="gender" required><option value="">Select Gender</option><option value="Male">Male</option><option value="Female">Female</option></select></div>
                            <div class="input-group"><label>Birthday</label><input type="date" name="birthday" /></div>
                            <div class="input-group"><label>Age *</label><input type="number" name="age" min="0" required /></div>
                    ...
                    <div id="edit-medical" class="tab-content">
                        <div class="form-group grid grid-cols-2 gap-4">
                            <div class="input-group"><label>Blood Type *</label><select name="blood_type" required><option value="">Select Blood Type</option><option value="O+">O+</option><option value="O-">O-</option><option value="A+">A+</option><option value="A-">A-</option><option value="B+">B+</option><option value="B-">B-</option><option value="AB+">AB+</option><option value="AB-">AB-</option></select></div>
                    ...
                    <div id="edit-organ-specific-information" class="tab-content">
                        <div class="form-group grid grid-cols-2 gap-4">
                            <div class="input-group"><label>Organ Needed *</label><input type="text" name="organ_needed" required /></div>
                    ...
                    <div id="edit-others" class="tab-content">
                        <div class="form-group grid grid-cols-2 gap-4">
                            ...
                            <div class="input-group"><label>Waiting Time *</label><input type="text" name="waiting_time" required /></div>
                            <div class="input-group"><label>Donation Preferences *</label><input type="text" name="donation_preferences" required /></div>
