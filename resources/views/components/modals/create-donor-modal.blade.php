                    ...
                    <div id="create-personal" class="tab-content active">
                        <div class="form-group grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="goverment_id_number" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required />
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Blood Type *</label>
                                <select name="blood_type" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm text-gray-700 font-normal" required>
                                    <option value="" class="text-gray-700 font-normal">Select Blood Type</option>
                            ...
                            <div>
                                ...
                                <input type="number" name="age" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required min="0" />
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Gender *</label>
                                <select name="gender" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm text-gray-700 font-normal" required>
                                    <option value="" class="text-gray-700 font-normal">Select Gender</option>
                            ...
                            <div>
                                ...
                                <select name="status" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm text-gray-700 font-normal" required>
                                    <option value="" class="text-gray-700 font-normal">Select Status</option>
                    ...
                    <div id="create-medical" class="tab-content">
                        <div class="form-group grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <textarea name="medical_history" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required rows="3"></textarea>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input type="text" name="donation_preferences" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required />
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="create-contact" class="tab-content">
                        <div class="form-group grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="email" name="contact_information" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required />
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Contact Number *</label>
                                <input type="text" name="contact_number" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required />
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Encoded By *</label>
                                <input type="text" name="encoded_by" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm text-gray-700 font-normal" value="{{ Auth::user()->name }}" required readonly />
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Encoded Date *</label>
                                <input type="date" name="encoded_date" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm text-gray-700 font-normal" value="{{ date('Y-m-d') }}" required readonly />
                            </div>
                        </div>
                    </div>
                </form>
